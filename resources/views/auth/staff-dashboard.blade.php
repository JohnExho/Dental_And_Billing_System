                            ...
                            <div class="list-group list-group-flush">
                                @forelse($todayAppointments as $appointment)
                                    <div class="list-group-item d-flex justify-content-between align-items-center">
                                        <div>
                                            <strong>{{ $appointment->patient->last_name }}, {{ $appointment->patient->first_name }}</strong><br>
                                            <small class="text-muted">{{ \Carbon\Carbon::parse($appointment->appointment_date)->format('g:i A') }}</small>
                                        </div>
                                        <span class="badge bg-primary">{{ ucfirst($appointment->appointment_type ?? 'Appointment') }}</span>
                                    </div>
                                @empty
