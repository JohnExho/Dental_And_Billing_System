    ...
    <div class="container">
        <div class="tooth-fleet">
            ...
            <svg class="tooth tooth-main" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M12 3C9 3 7 4 6 6C5 8 5 10 5 12C5 14 5 16 6 18C7 19 8 20 9 20C9.5 19.5 10 19 10.5 18.5C11 18 11.5 18 12 18C12.5 18 13 18 13.5 18.5C14 19 14.5 19.5 15 20C16 20 17 19 18 18C19 16 19 14 19 12C19 10 19 8 18 6C17 4 15 3 12 3Z"
                    fill="white" stroke="#E0E0E0" stroke-width="0.5" />
                <path d="M8.5 18C7.5 19 7 19.5 6.5 20C7 20.5 7.5 21 8 21C8.5 20.5 9 20 9 19.5C9 19 8.5 18.5 8.5 18Z"
                    fill="#FFD700" />
                <path
                    d="M15.5 18C16.5 19 17 19.5 17.5 20C17 20.5 16.5 21 16 21C15.5 20.5 15 20 15 19.5C15 19 15.5 18.5 15.5 18Z"
                    fill="#FFD700" />
                <circle cx="10" cy="8" r="1.5" fill="#87CEEB" opacity="0.6" />
                <line x1="10" y1="6.5" x2="10" y2="9.5" stroke="white" stroke-width="0.8"
                    opacity="0.8" />
                <line x1="8.5" y1="8" x2="11.5" y2="8" stroke="white" stroke-width="0.8"
                    opacity="0.8" />
            </svg>
            ...
            <svg class="tooth tooth-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M12 3C9 3 7 4 6 6C5 8 5 10 5 12C5 14 5 16 6 18C7 19 8 20 9 20C9.5 19.5 10 19 10.5 18.5C11 18 11.5 18 12 18C12.5 18 13 18 13.5 18.5C14 19 14.5 19.5 15 20C16 20 17 19 18 18C19 16 19 14 19 12C19 10 19 8 18 6C17 4 15 3 12 3Z"
                    fill="rgba(255,255,255,0.9)" stroke="#E0E0E0" stroke-width="0.4" />
                <path d="M8.5 18C7.5 19 7 19.5 6.5 20C7 20.5 7.5 21 8 21C8.5 20.5 9 20 9 19.5C9 19 8.5 18.5 8.5 18Z"
                    fill="#FFA500" />
                <path
                    d="M15.5 18C16.5 19 17 19.5 17.5 20C17 20.5 16.5 21 16 21C15.5 20.5 15 20 15 19.5C15 19 15.5 18.5 15.5 18Z"
            ...
            <svg class="tooth tooth-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M12 3C9 3 7 4 6 6C5 8 5 10 5 12C5 14 5 16 6 18C7 19 8 20 9 20C9.5 19.5 10 19 10.5 18.5C11 18 11.5 18 12 18C12.5 18 13 18 13.5 18.5C14 19 14.5 19.5 15 20C16 20 17 19 18 18C19 16 19 14 19 12C19 10 19 8 18 6C17 4 15 3 12 3Z"
                    fill="rgba(255,255,255,0.85)" stroke="#E0E0E0" stroke-width="0.3" />
                <path d="M8.5 18C7.5 19 7 19.5 6.5 20C7 20.5 7.5 21 8 21C8.5 20.5 9 20 9 19.5C9 19 8.5 18.5 8.5 18Z"
                    fill="#FF8C00" />
                <path
                    d="M15.5 18C16.5 19 17 19.5 17.5 20C17 20.5 16.5 21 16 21C15.5 20.5 15 20 15 19.5C15 19 15.5 18.5 15.5 18Z"
        ...
        <p>Oops! This page has drifted away like a lost tooth in space. It might have been extracted, relocated, or
