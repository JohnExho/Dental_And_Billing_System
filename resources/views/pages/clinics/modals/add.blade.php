                ...
                <div class="modal-body">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="clinic_name" name="name"
                                        placeholder="Clinic Name" value="{{ old('name', $clinic->name ?? '') }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="clinic_description"
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="speciality" name="speciality"
                                            ...
                                            value="{{ old('speciality', $clinic->speciality ?? '') }}">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email"
                                            placeholder="Email address" value="{{ old('email', $clinic->email ?? '') }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control phone-number" id="contact_no"
                                            ...
                                            value="{{ old('contact_no', $clinic->contact_no ?? '') }}" maxlength="11"
                                            required>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control phone-number" id="mobile_no"
                                            ...
                                            value="{{ old('mobile_no', $clinic->mobile_no ?? '') }}" maxlength="11"
                                            required>
                                    </div>
                                    <div class="form-text">11-digit format only</div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <input type="text" class="form-control" id="house_no" name="address[house_no]"
                                        placeholder="House No." value="{{ old('house_no', $clinic->house_no ?? '') }}">
                                </div>
                                <div class="col-md-8 mb-3">
                                    <input type="text" class="form-control" id="street" name="address[street]"
                                        placeholder="Street" value="{{ old('street', $clinic->street ?? '') }}">
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control" id="schedule_summary"
                                    name="schedule_summary" placeholder="Summary (e.g. Mon-Fri 9AM-5PM)"
                                        ...
                                        <div class="day-row col-12 mb-2">
                                            <div class="form-check mb-1">
                                                <input class="form-check-input day-check" type="checkbox"
                                                    ...
                                                    {{ old('schedule.' . $day . '.active') ? 'checked' : '' }}>
