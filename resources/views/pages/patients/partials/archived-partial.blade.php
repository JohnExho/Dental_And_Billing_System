        ...
        function initializeActionButtons() {
            ...
            document.querySelectorAll('.unarchive-patient-btn').forEach(btn => {
                btn.addEventListener('click', function(e) {
                    ...
                    document.getElementById('unarchive_patient_id').value = patientId;
                    document.getElementById('unarchive_patient_name').textContent = patientName;
            ...
            document.querySelectorAll('.delete-patient-btn').forEach(btn => {
                btn.addEventListener('click', function(e) {
                    ...
                    document.getElementById('delete_patient_name').textContent = patientName;
