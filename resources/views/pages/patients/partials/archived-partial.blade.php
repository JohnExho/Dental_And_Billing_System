    ...
    function initializeActionButtons() {
        ...
        document.querySelectorAll('.unarchive-patient-btn').forEach(btn => {
            btn.addEventListener('click', function(e) {
                ...
                // Check if modal elements exist before setting values
                ...
                if (!unarchiveIdInput || !unarchiveNameSpan || !unarchiveModalEl) {
                    console.error('Unarchive modal elements not found in DOM');
                    alert('Error: Modal not properly loaded. Please refresh the page.');
                    return;
                }
