<div class="card-body p-0">
    ...
    <div class="p-3 bg-light border-bottom">
        <div class="input-group">
            ...
            <input type="text" id="patient-search" class="form-control" placeholder="Search archived patients...">
            ...
            <table class="table table-hover align-middle mb-0 table-striped table-warning" id="patients-table">
                ...
                <tbody id="patients-tbody">
                    @foreach ($patients as $patient)
                        ...
                        <tr class="patient-row" data-search-name="{{ strtolower($patient->full_name) }}"
                            ...
                            <td class="text-end">
                                <!-- Restore Button -->
                                <button type="button" class="btn btn-sm btn-outline-success restore-patient-btn"
