...
<!-- Add associate Modal -->
<div class="modal fade" id="add-associate-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content shadow-lg border-0 rounded-3">
            <form action="{{ route('process-create-associate') }}" method="POST">
                @csrf
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title">
                        <i class="bi bi-person-plus me-2"></i> Add New associate
                    </h5>
                            ...
                            <div class="column">
                                <div class="col-md-12 mb-3">
                                    <input type="text" class="form-control" name="first_name"
                                        ...
                                        value="{{ old('first_name', $associate->first_name ?? '') }}" required>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <input type="text" class="form-control" name="middle_name"
                                        placeholder="Middle Name"
                                        value="{{ old('middle_name', $associate->middle_name ?? '') }}">
                                </div>
                                <div class="col-md-12 mb-3">
                                    <input type="text" class="form-control" name="last_name" placeholder="Last Name"
                                        value="{{ old('last_name', $associate->last_name ?? '') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                        placeholder="Email address" value="{{ old('email', $associate->email ?? '') }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control phone-number" id="contact_no"
                                            ...
                                            value="{{ old('contact_no', $associate->contact_no ?? '') }}" maxlength="11"
                                            required>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control phone-number" id="mobile_no"
                                            ...
                                            value="{{ old('mobile_no', $associate->mobile_no ?? '') }}" maxlength="11"
                                            required>
                                    </div>
                                    <div class="form-text">11-digit format only</div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <input type="text" class="form-control" id="house_no" name="address[house_no]"
                                        ...
                                        value="{{ old('house_no', $associate->house_no ?? '') }}">
                                </div>
                                <div class="col-md-8 mb-3">
                                    <input type="text" class="form-control" id="street" name="address[street]"
                                        placeholder="Street" value="{{ old('street', $associate->street ?? '') }}">
                                </div>
                            </div>
                                    ...
                                    <select id="province-select" class="form-select" required>
                                        ...
                                        @foreach ($provinces as $province)
                                            <option value="{{ $province->province_id }}"
                                                data-id="{{ $province->id }}"
                                                {{ old('province_id', $associate->province_id ?? '') == $province->id ? 'selected' : '' }}>
                                                {{ $province->name }}
                                            </option>
                                        @endforeach
                                    </select>
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save me-1"></i> Save associate
                    </button>
                </div>
            </form>
        </div>
...
<script>
    (function() {
        const modal = document.getElementById('add-associate-modal');
        if (!modal) return;
