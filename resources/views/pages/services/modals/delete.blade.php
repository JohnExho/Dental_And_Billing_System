...
<div class="modal fade" id="delete-service-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('process-delete-service') }}" method="POST">
                @csrf
                @method('DELETE')
                <input type="hidden" name="service_id" id="delete_service_id" value="">

                <div class="modal-header">
                    <h5 class="modal-title text-danger">Confirm service Deletion</h5>
