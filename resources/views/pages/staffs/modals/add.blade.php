        ...
        <div class="modal-body">
          <div class="row g-4">
                ...
                <div class="col-md-6 mb-3">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control phone-number" id="contact_no" name="contact_no"
                      placeholder="Phone / Landline" value="{{ old('contact_no', $staff->contact_no ?? '') }}"
                ...
                <div class="col-md-6 mb-3">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control phone-number" id="mobile_no" name="mobile_no"
                      placeholder="Mobile No" value="{{ old('mobile_no', $staff->mobile_no ?? '') }}" maxlength="11"
                      required>
                  </div>
                  <div class="form-text">11-digit format only</div>
                </div>
            ...
            <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-4 mb-3">
                  <input type="text" class="form-control" id="house_no" name="address[house_no]" placeholder="House No."
                    value="{{ old('house_no', $staff->house_no ?? '') }}">
                </div>
                ...
                <div class="col-md-4 mb-3">
                  <select id="province-select" class="form-select" required>
                    ...
                    @foreach($provinces as $province)
                      <option value="{{ $province->province_id }}" {{ old('province_id', $staff->province_id ?? '') == $province->province_id ? 'selected' : '' }}>
                        {{ $province->name }}
                      </option>
