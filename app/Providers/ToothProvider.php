...
class ToothProvider extends ServiceProvider
{
    ...
    {
        View::composer(['pages.progress-notes.modals.add','pages.prescriptions.modals.add','pages.prescriptions.modals.edit', 'pages.treatments.modals.add', 'pages.treatments.modals.edit'], function ($view) {
